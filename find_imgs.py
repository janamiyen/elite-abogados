...
<head>
  ...
  <style>
    ...
    /* Marquee infinito para marcas / clientes */
...
<body class="selection:bg-neutral-800 selection:text-white">
  ...
  <section class="relative h-screen h-[100dvh] max-h-screen w-full flex flex-col justify-between text-white overflow-hidden box-border">
    ...
    <!-- Top Navigation Bar con divisores sutiles y logo proporcionado -->
    <header class="hero-delay-nav relative z-20 w-full px-6 sm:px-12 py-5 sm:py-6 flex items-center justify-between border-b border-white/[0.08] shrink-0">
      ...
      <!-- Brand Logo (Isotipo más grande + Text exacto a Framer) -->
      ...
      <!-- Center Navigation con divisores sutiles (delgados) -->
      <nav class="hidden md:flex items-center text-[13.5px] font-normal text-white/85">
        <a href="#about" class="px-5 py-1.5 hover:text-white transition-colors">About</a>
        <span class="w-[1px] h-3.5 bg-white/20"></span>
        
        <div class="relative group cursor-pointer flex items-center gap-1.5 px-5 py-1.5 hover:text-white transition-colors">
          <span>Services</span>
        ...
        <a href="#case-studies" class="px-5 py-1.5 hover:text-white transition-colors">Case studies</a>
        <span class="w-[1px] h-3.5 bg-white/20"></span>

        <a href="#approach" class="px-5 py-1.5 hover:text-white transition-colors">Insights</a>
      </nav>
    ...
    <div class="relative z-10 w-full max-w-[1240px] mx-auto px-6 sm:px-12 my-auto py-2 flex flex-col justify-center">
      ...
      <!-- Fluid responsive heading: reduced by 10% for optimal balanced weight -->
      <h1 class="hero-slide-in hero-delay-title text-3xl sm:text-4xl md:text-5xl lg:text-[68px] xl:text-[75px] font-normal leading-[1.06] tracking-tighter text-white max-w-3xl mb-5 sm:mb-6">
        Reimagine What Your Business Can Achieve
      </h1>

      <p class="hero-slide-in hero-delay-p text-neutral-300 text-sm sm:text-base md:text-lg font-normal leading-relaxed max-w-lg mb-7 sm:mb-9">
  ...
  <!-- ==================== MARQUEE: CLIENTES / MARCAS CON QUIENES TRABAJAMOS ==================== -->
  <section class="w-full bg-[#f2f3f5] border-b border-black/10 py-9 overflow-hidden relative">
    
    <!-- Sutiles gradientes de fade en los bordes para suavizar la entrada y salida -->
    ...
    <div class="marquee-track flex items-center gap-16 sm:gap-24 opacity-60 hover:opacity-90 transition-opacity">
      ...
      <!-- Set 1 -->
      <div class="flex items-center gap-3 tracking-tight font-semibold text-[#081014] text-lg sm:text-xl">
        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="12" r="4"/></svg>
        <span>Spherule</span>
      </div>

      <div class="flex items-center gap-3 tracking-tight font-semibold text-[#081014] text-lg sm:text-xl">
        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M4 6h16l-3 4H7L4 6zm2 6h12l-3 4H9l-3-4zm2 6h8l-2 3h-4l-2-3z"/></svg>
        <span>FeatherDev</span>
      </div>

      <div class="flex items-center gap-3 tracking-tight font-semibold text-[#081014] text-lg sm:text-xl">
        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24"><polygon points="6,4 18,4 21,12 18,20 6,20 3,12" fill="currentColor"/></svg>
        <span>GlobalBank</span>
      </div>

      <div class="flex items-center gap-3 tracking-tight font-semibold text-[#081014] text-lg sm:text-xl">
        <svg class="w-6 h-6 fill-none stroke-currentColor" stroke-width="2.2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"/><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"/><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"/></svg>
        <span>Nietzsche</span>
      </div>

      <div class="flex items-center gap-3 tracking-tight font-semibold text-[#081014] text-lg sm:text-xl">
        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zm0 9l-8-4v6l8 4 8-4v-6l-8 4z"/></svg>
        <span>KiteLegal</span>
      </div>

      <div class="flex items-center gap-3 tracking-tight font-semibold text-[#081014] text-lg sm:text-xl">
        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
        <span>Polymath</span>
      </div>
